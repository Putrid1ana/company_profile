...
$routes->get('produk1', 'Home::produk1');  // Rute untuk halaman Produk1
$routes->get('produk2', 'Home::produk2');  // Rute untuk halaman produk2
$routes->get('produk3', 'Home::produk3');  // Rute untuk halaman produk3
$routes->get('produk4', 'Home::produk4');  //Rute untuk halaman produk4
